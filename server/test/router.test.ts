...
describe('movie API', () => {
  ...
  const catalog = new CatalogService(new MemoryStore([
    ...
    { movie_id: 'series-1-s1-e1', title: 'Demo Series', type: 'series', status: 'published', season: '1', episode: '1', created_at: '2026-01-04T00:00:00Z', telegram_chat_id: '-100123', telegram_message_id: '789', telegram_file_id: 'file-1' },
  ...
  it('provides a signed backend media URL for playable Telegram metadata', async () => {
  ...
  it('rejects playback when the Telegram file reference is missing', async () => {
